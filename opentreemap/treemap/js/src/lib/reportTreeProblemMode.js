...
var $ = require('jquery'),
    ...
    reportTreeProblem = require('treemap/lib/reportTreeProblem.js'),
...
function init(options) {
    var plotMarker = options.plotMarker,
        ...
        manager = reportTreeProblem.init(_.extend({clearEditControls: clearEditControls}, options)),
        hideSearch;
